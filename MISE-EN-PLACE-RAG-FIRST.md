# ✅ MISE EN PLACE : Principe "RAG First"
...
**Localisation**: `CORE.md` (ligne ~116)

---

### 3. Script utilitaire (`scripts/check-rag-first.sh`)
...
2. ✅ `CORE.md` - Documentation mise à jour (modifié)
3. ✅ `scripts/check-rag-first.sh` - Script utilitaire (nouveau)
4. ✅ `MISE-EN-PLACE-RAG-FIRST.md` - Ce document (nouveau)
